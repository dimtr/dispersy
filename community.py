...
class Community(object):
    ...
    def create_dispersy_signature_request(self, candidate, message, response_func, response_args=(), success_func=None, success_args=(), timeout=10.0, forward=True):
        return self._dispersy.create_signature_request(self, candidate, message, response_func, response_args, success_func, success_args, timeout, forward)
